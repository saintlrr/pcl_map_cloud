...
// g2o::EdgeSE3Prior* GraphSLAM::add_se3_prior_edge(g2o::VertexSE3* v_se3, const g2o::VertexSE3* v0, const Eigen::MatrixXd& information_matrix) {
//   g2o::EdgeSE3Prior* edge(new g2o::EdgeSE3Prior());
//   edge->setMeasurement(v0);
//   edge->setInformation(information_matrix);
//   edge->vertices()[0] = v_se3;
//   graph->addEdge(edge);
